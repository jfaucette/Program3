...
namespace Prog2
{
    public partial class LetterForm : Form
    {
        ...
        public int DestinationAddressIndex
        {
        ...
        // Precondition:  Validating of fixedCostTxt not cancelled, so data OK
        // Postcondition: Error provider cleared and focus allowed to change
        private void fixedCostTxt_Validated(object sender, EventArgs e)
        {
            errorProvider.SetError(fixedCostTxt, "");
        }
        ...
        private void addressCbo_Validating(object sender, CancelEventArgs e)
        {
            ...
            ComboBox cbo = (ComboBox)sender; // Sender as combo box
        ...
        // Precondition:  Validating of one of the address combo boxes not cancelled, so data OK
        // Postcondition: Error provider cleared and focus allowed to change

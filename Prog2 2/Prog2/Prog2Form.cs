    ...
    public partial class Prog2Form : Form
    {
        ...
        private void aboutToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show(String.Format("Program 2{0}By: Andrew L. Wright{0}" +
                "CIS 200{0}Fall 2014", Environment.NewLine), "About Program 2");
        }
        ...
        //Precondition: Save the report.
        //Postcondition: Saves the results in the report box as a file.
        ...
        //Precondition: Edit, Edit Address menu activated.
        //Postcondition: The Edit Address dialog box is displayed. If data entered
        //                are OK, the addresses in the AddressList are updated.
        private void addressToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            EditAddress editAddress = new EditAddress(addressList); // The address dialog box form
            DialogResult result = editAddress.ShowDialog(); // Show form as dialog and store result

        }// end click event

        //Precondition: Opens the report.
        //Postcondition: Opens the file of addresses to make them.
